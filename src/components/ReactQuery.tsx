    ...
    <>
      <div className="lg:flex w-full justify-evenly mt-10 p-2 bg-slate-400 py-24">
        <div>
          ...
          <Typography className="text-white text-lg lg:w-[500px] 2xl:w-[700px] mt-2">
            Si puedes notar hay archivos adicionales los cuales no vamos a mirar
            pero tienen la misma logica y los invito a explorar como deberian
            ser dichas implementaciones.
          </Typography>
        </div>
